...
const OrderView = ({ id, getListData, presetData }) => {
	...
	const handleSave = useCallback(() => {
		...
		trading.liveDetailUpload(editData, null, () => {
			showMessage({
	...
	const handleEdit = useCallback(() => {
		...
		trading.liveDetailEdit(editData, null, () => {
			showMessage({
		...
		<div className="h-full w-full bg-[#1B1B1B] p-4 text-white md:p-5">
			<div className="space-y-3 md:space-y-4">
						...
						<div>
							...
							<div className={dropdownWrapClass}>
								<DefaultDropdown
									...
									option={['Aggresisve', 'Conservative', 'Neutral']}
									className={'w-full'}
								/>
							</div>
						</div>
						...
						<div>
							...
							<div className={dropdownWrapClass}>
								<DefaultDropdown
									...
									setIsOpen={setSignalTypeDropDownOn}
				...
				<div className="flex justify-end">
					{mode === 'add' ? (
						<button
							className="rounded-lg border border-[#494949] px-6 py-2.5 text-white transition-colors hover:bg-[#0f0f0f]"
							onClick={handleSave}
						>
							Add
						</button>
