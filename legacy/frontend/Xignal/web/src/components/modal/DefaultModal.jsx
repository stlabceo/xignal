...
export const DefaultModal = ({
	...
	const contentClasses = isFullscreen ? 'w-full h-full' : 'relative rounded-xl bg-[#0F0F0F] border border-[#494949]';

	return (
		<div className="fixed inset-0 flex items-center justify-center overflow-y-auto modal z-99999">
			{!isFullscreen && <div className="fixed inset-0 h-full w-full bg-[#000]/50 backdrop-blur-[5px]" onClick={onClose}></div>}
