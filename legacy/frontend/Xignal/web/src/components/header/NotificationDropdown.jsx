		...
		<div className="relative">
			...
			>
				<div className="flex items-center justify-between pb-3 mb-3 border-b border-gray-100">
					...
					<button onClick={toggleDropdown} className="text-gray-500 transition hover:text-gray-700">
				...
				<ul className="flex flex-col h-auto overflow-y-auto custom-scrollbar">
						...
						>
							...
							<span className="block">
								<span className="mb-1.5 block  text-theme-sm text-gray-500 space-x-1">
									...
									<span className="font-medium text-gray-800 ">Project - Nganter App</span>
								</span>
						...
						>
							...
							<span className="block">
								<span className="mb-1.5 block space-x-1 text-theme-sm text-gray-500 ">
									<span className="font-medium text-gray-800">Alena Franci</span>
									<span>requests permission to change</span>
									<span className="font-medium text-gray-800">Project - Nganter App</span>
								</span>
					...
					<li>
						...
						>
							...
							<span className="block">
								<span className="mb-1.5 block space-x-1 text-theme-sm text-gray-500 ">
									<span className="font-medium text-gray-800 ">Jocelyn Kenter</span>
									<span> requests permission to change</span>
									<span className="font-medium text-gray-800 ">Project - Nganter App</span>
								</span>
						...
						>
							...
							<span className="block">
								<span className="mb-1.5 space-x-1 block text-theme-sm text-gray-500 ">
									<span className="font-medium text-gray-800 ">Brandon Philips</span>
									<span>requests permission to change</span>
									<span className="font-medium text-gray-800 ">Project - Nganter App</span>
								</span>
