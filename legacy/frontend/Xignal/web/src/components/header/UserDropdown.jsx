...
export default function UserDropdown() {
	...
	return (
		<div className="relative">
			<button onClick={toggleDropdown} className="flex items-center text-gray-700 dropdown-toggle ">
			...
			>
				<div>
					<span className="block font-medium text-gray-700 text-theme-sm ">Musharof Chowdhury</span>
					<span className="mt-0.5 block text-theme-xs text-gray-500 ">randomuser@pimjo.com</span>
				</div>
